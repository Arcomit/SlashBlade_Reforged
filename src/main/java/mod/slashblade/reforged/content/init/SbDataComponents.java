...
public class SbDataComponents {
    ...
    public static final Supplier<DataComponentType<ResourceLocation>> MODEL_LOCATION =
            DATA_COMPONENTS.register("model_location", () ->
    ...
    public static final Supplier<DataComponentType<ResourceLocation>> TEXTURE_LOCATION =
            DATA_COMPONENTS.register("texture_location", () ->
                    DataComponentType.<ResourceLocation>builder()
                            .persistent(ResourceLocation.CODEC)
                            .networkSynchronized(ResourceLocation.STREAM_CODEC)
                            .build()
