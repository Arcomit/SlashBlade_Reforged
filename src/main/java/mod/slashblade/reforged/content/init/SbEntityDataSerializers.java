...
public class SbEntityDataSerializers {
    ...
    public static final Supplier<EntityDataSerializer<Double>> DOUBLE = ENTITY_DATA_SERIALIZERS.register("double", () -> EntityDataSerializer.forValueType(ByteBufCodecs.DOUBLE));
